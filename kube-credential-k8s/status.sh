...
echo "------------------------"
echo "   Port forward issuance:    kubectl port-forward service/issuance-service 3000:3000 -n kube-credential"
echo "   Port forward verification: kubectl port-forward service/verification-service 3001:3001 -n kube-credential"
